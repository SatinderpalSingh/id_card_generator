          ...
          <nav class="mt-4">
            <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-compact nav-flat nav-child-indent nav-collapse-hide-child" data-widget="treeview" role="menu" data-accordion="false">
              ...
              <?php if ($_settings->userdata('type') == 1  &&  $_settings->userdata('usertype') == 'school') : ?>
                ...
                <li class="nav-item dropdown">
                  <a href="<?php echo base_url ?>admin/?page=school/upload_data" class="nav-link nav-system_info">
                ...
                <li class="nav-item dropdown">
                  <a href="<?php echo base_url ?>admin/?page=school/classes_list" class="nav-link nav-system_info">
                    <i class="nav-icon fas fa-th-list"></i>
                    <p>
                      Classes List
                    </p>
